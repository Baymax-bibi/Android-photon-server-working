...
public class DemoActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		((Button)findViewById(R.id.buttonCreateDirectAllToAll)).setOnClickListener(new OnClickListener()
		{
			public void onClick(View v)
			{
				mViewMasterServer.setVisibility(View.INVISIBLE);
		...
		((Button)findViewById(R.id.buttonCreateDirectMasterToAll)).setOnClickListener(new OnClickListener()
		{
			public void onClick(View v)
			{
				mViewMasterServer.setVisibility(View.INVISIBLE);
