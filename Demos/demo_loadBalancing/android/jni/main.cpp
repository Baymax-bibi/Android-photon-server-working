...
extern "C"
{
	...
	JNIEXPORT void JNICALL Java_demo_android_loadBalancing_DemoActivity_createGameDirectAllToAll(JNIEnv* env, jobject obj);
	JNIEXPORT void JNICALL Java_demo_android_loadBalancing_DemoActivity_createGameDirectMasterToAll(JNIEnv* env, jobject obj);
